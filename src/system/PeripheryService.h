...
class PeripheryService {
 public:
  ...
  using ButtonPost = std::function<void(const std::string&, const char*, bool, const std::string&)>;
  void setButtonPost(ButtonPost post) { buttonPost_ = std::move(post); }
